 ...
 * </ul>
 *
 * <h2>Chunk handling</h2>
 * <ul>
 *   <li>{@link ChunkGenerationMode#QUEUE} — default, defers unloaded chunks into
 *       SSL's persistent queue.</li>
 *   <li>{@link ChunkGenerationMode#FORCE_GENERATE} — synchronously prepares the
 *       required chunks before placement.</li>
 * </ul>
 */
public final class StructurePlacement {
    ...
    /**
     * Override how SSL handles unloaded chunks for this placement.
     *
     * <p>Defaults to {@link ChunkGenerationMode#QUEUE}.
     */
    public StructurePlacement withChunkGenerationMode(ChunkGenerationMode mode) {
        this.chunkGenerationMode = mode == null ? ChunkGenerationMode.QUEUE : mode;
        return this;
    }
     ...
     *
        * <p>By default, blocks in unloaded chunks are deferred to the world's
        * persistent {@link StructureQueue}. Use
        * {@link #withChunkGenerationMode(ChunkGenerationMode)} to opt into
        * immediate chunk preparation instead.
     *
